...
namespace Switch.Script.CsScript.Action
{
    ...
    public class Action42 : BaseAction
    {
        ...
        public Action42(ActionGetter actionGetter)
            : base(ActionIDDefine.CstAction42, actionGetter)
        {
        ...
        public override bool TakeAction()
        {
            ...
            {
                Current.Bind(new SessionUser() { UserId = (int)GlobalDefine.ServerIdType.WabaoziId, PassportId = string.Format("WabaoziS-{0}", _serverId) });
                //设置忽略锁
        ...
        public async void SendLoginResult()
        {
            ...
            param["ActionId"] = ActionIDDefine.CstAction43;
            param["msgid"] = 0;
