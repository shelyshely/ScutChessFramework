...
namespace Switch.Script.CsScript.Action
{
    ...
    public class Action12 : BaseAction
    {
        ...
        public Action12(ActionGetter actionGetter)
            : base(ActionIDDefine.CstAction12, actionGetter)
        {
        ...
        public override bool TakeAction()
        {
            ...
            if (key == _word && !ServerHelper.IsExistCS(_serverId))
            {
                ...
                if(freeUserId > 0)
                {
                    Current.Bind(new SessionUser() { UserId = freeUserId, PassportId = string.Format("ConnectS-{0}", _serverId) });
                    //设置忽略锁
        ...
        public async void SendLoginResult()
        {
            ...
            param["ActionId"] = ActionIDDefine.CstAction13;
            param["msgid"] = 0;
