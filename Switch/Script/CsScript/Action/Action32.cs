...
namespace Switch.Script.CsScript.Action
{
    ...
    public class Action32 : BaseAction
    {
        ...
        public Action32(ActionGetter actionGetter)
            : base(ActionIDDefine.CstAction32, actionGetter)
        {
        ...
        public override bool TakeAction()
        {
            ...
            {
                Current.Bind(new SessionUser() { UserId = (int)GlobalDefine.ServerIdType.SuperMonreyId, PassportId = string.Format("SuperMonreyS-{0}", _serverId) });
                //设置忽略锁
