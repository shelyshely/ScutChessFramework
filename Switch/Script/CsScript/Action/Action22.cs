...
namespace Switch.Script.CsScript.Action
{
    ...
    public class Action22 : BaseAction
    {
        ...
        public Action22(ActionGetter actionGetter)
            : base(ActionIDDefine.CstAction22, actionGetter)
        {
        ...
        public override bool TakeAction()
        {
            ...
            {
                Current.Bind(new SessionUser() { UserId = (int)GlobalDefine.ServerIdType.SocialId, PassportId = string.Format("SocialS-{0}", _serverId) });
                //设置忽略锁
        ...
        public async void SendLoginResult()
        {
            ...
            param["ActionId"] = ActionIDDefine.CstAction23;
            param["msgid"] = 0;
