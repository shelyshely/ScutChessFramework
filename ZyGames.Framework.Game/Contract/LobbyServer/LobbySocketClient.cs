...
namespace ZyGames.Framework.Game.Contract.LobbyServer
{
    /// <summary>
    /// 大厅服Socket通讯
    /// </summary>
    public abstract class LobbySocketClient : GameBaseHost
    {
        ...
        private ClientSocket _socketLobby;
        ...
        { get { return _socketLobby.Connected; }
            private set { _socketLobby.Connected = value; }
        }
        ...
        protected void Init(string host, int port, int heartInterval)
        {
            ...
            _socketLobby = new ClientSocket(settings);
            _socketLobby.DataReceived += new SocketEventHandler(roomSocket_DataReceived);
            _socketLobby.Disconnected += new SocketEventHandler(roomSocket_Disconnected);
        ...
        public async System.Threading.Tasks.Task Send(byte[] data)
        {
            ...
            await _socketLobby.PostSend(data, 0, data.Length);
        }
